...
Scenario: [Mobile][Abandonment popup] I'm just browsing
...
When I wait `PT30S` with `PT05S` polling until element located `${xpathFor_MedicationRefillsInMob}` becomes VISIBLE
When I click on element located `${xpathFor_MedicationRefillsInMob}`
