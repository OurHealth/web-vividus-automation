...
When I wait until state of element located `${xpathFor_SelectHealthCenter}` is ENABLED
When I click on element located `${xpathFor_SelectHealthCenter}`
When I wait `PT10S` with `PT05S` polling until element located `${xpathFor_SelectFishersBehavioralHealthFromHealthCenter}` becomes VISIBLE
When I click on element located `${xpathFor_SelectFishersBehavioralHealthFromHealthCenter}`
...
When I wait `PT10S` with `PT05S` polling until element located `${xpathFor_SelectAllieGilTroutFromProviders}` becomes VISIBLE
When I click on element located `${xpathFor_SelectAllieGilTroutFromProviders}`
