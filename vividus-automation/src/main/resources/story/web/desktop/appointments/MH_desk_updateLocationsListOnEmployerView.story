...
When I wait `PT30S` with `PT15S` polling until element located `${xpathFor_HCL_mobAflacClinic1}` becomes VISIBLE
When I wait `PT30S` with `PT10S` polling until element located `${xpathFor_HCL_mobAflacClinic2}` becomes VISIBLE
