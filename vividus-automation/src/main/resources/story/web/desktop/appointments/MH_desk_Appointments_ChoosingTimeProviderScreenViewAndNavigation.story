...
When I wait `PT30S` with `PT10S` polling until element located `${xpathFor_ClinicNameInMaps}` becomes VISIBLE
When I wait `PT30S` with `PT10S` polling until element located `${xpathFor_ClinicAddressInMaps}` becomes VISIBLE
When I wait `PT30S` with `PT10S` polling until element located `${xpathFor_DistanceInMap}` becomes VISIBLE
When I wait `PT30S` with `PT10S` polling until element located `${xpathFor_DirectionsInMap}` becomes VISIBLE
