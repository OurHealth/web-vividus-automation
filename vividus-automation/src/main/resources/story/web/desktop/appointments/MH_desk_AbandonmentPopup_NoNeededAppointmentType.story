...
Scenario: [Desktop][Abandonment popup] No needed appointment type
...
When I wait `PT30S` with `PT10S` polling until element located `${xpathFor_messages}` becomes VISIBLE
