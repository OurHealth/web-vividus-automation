...
When I wait `PT20S` with `PT05S` polling until element located `${xpathFor_HCS_InHomePage}` becomes VISIBLE
...
When I wait `PT10S` with `PT05S` polling until element located `${xpathFor_welcomeMarathonHealth}` becomes VISIBLE
